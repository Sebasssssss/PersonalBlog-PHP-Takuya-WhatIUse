...
<head>
  ...
  <link rel="icon" href="../frontend/images/pawda.png">
...
<body class="bg-orange-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-300 transition-colors duration-500">
  ...
  <section class="px-8 mx-auto max-w-3xl mt-20">
    <div>
      ...
      as Takuya Matsuyama. Nowadays I'm coding php and using Tailwindcss as a 
    ...
    ?>
      <a href="pages/cardsData.php?action=loadCard&cards=<?=$cards['id']?>" class="w-full mb-4 text-center">
