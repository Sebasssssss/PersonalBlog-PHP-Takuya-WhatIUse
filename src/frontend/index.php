...
<body class="bg-orange-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-300 transition-colors duration-500">
  ...
  <section class="px-8 mx-auto max-w-3xl">
    ...
    <ul class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <li>
        <a href="https://tailwindcss.com/" class="w-[345px] mb-4 text-center">
          <img src="images/tailwindcss.png" class="w-full border border-slate-300 dark:border-slate-700 rounded-xl h-44 object-cover">
          <h1 class="text-xl mt-3 font-semibold font-mplus">tailwindcss</h1>
          <h6 class="opacity-70 text-sm">Tailwind CSS is a css framework open source for web design.</h6>
        </a>
      </li>
      <li>
