...
<html class="scroll-smooth">
  ...
  <body class="bg-zinc-900 text-zinc-300 overflow-hidden">
    <header class="backdrop-blur-md w-full p-2 z-40 fixed">
      <div class="max-w-3xl mx-auto relative h-11">
        <nav class="flex items-center gap-3">
          <a href="" id="myName" class="group text-lg p-2 font-semibold font-mplus inline-flex items-center gap-1.5 text-center tracking-tighter">
          ...
          <div class="items-center gap-6 hidden md:inline-flex pt-0.5">
            <a href="" class="text-md">About Me</a>
            <a href="" class="inline-flex items-center text-md gap-1">
          ...
          <div @click.away="open = false" class="absolute right-0" x-data="{ open: false }">
            <button @click="open = !open" class="rounded-md border border-zinc-700 py-2 text-sm shadow-sm">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 w-56 mt-2 origin-top-right rounded-md shadow-lg flex flex-col border border-zinc-700 bg-zinc-800 px-2 py-1">
              <h1 class="py-2 mx-1 text-left text-xs uppercase tracking-tighter font-bold">Categories</h1>
              <a href="index.php?r=cards" class="w-full text-left hover:bg-zinc-700 px-2 py-2 rounded text-sm">Cards</a>
              <a href="index.php?r=aboutme" class="w-full text-left hover:bg-zinc-700 px-2 py-2 rounded text-sm">About Me</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <div class="w-full h-screen z-40 fixed left-0 top-0 justify-center items-center flex flex-col gap-1.5 backdrop-blur-sm">
      ...
      <div class="dark:bg-zinc-900/[0.98] w-96 h-96 rounded-lg flex flex-row items-center relative shadow-2xl shadow-zinc-800 border border-zinc-700">
