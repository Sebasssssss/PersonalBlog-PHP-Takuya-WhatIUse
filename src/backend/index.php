<?php
  ...
  require("models/cards_model.php");
      ...
      <div class="max-w-3xl mx-auto relative h-11">
        <nav class="flex items-center gap-3">
          ...
          <div class="text-xl list-none flex flex-col absolute right-12 border dark:border-orange-50 border-slate-800/70 rounded-md overflow-hidden">
            ...
            <div id="sun" class="w-full h-full py-1.5 px-2 bg-[#2e1d52] hover:bg-[#191617] shadow-inner shadow-zinc-900 cursor-pointer transition-transform duration-500">
